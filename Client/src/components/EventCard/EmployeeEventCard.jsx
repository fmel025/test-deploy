...
const EventCard = () => {
    return(
        <Link to='/employee_event_details' className='bg-white cursor-pointer w-64 h-92 border rounded-lg hover:shadow-xl'>
        ...
        <div className='m-4'>
          ...
          <p className='ml-5 text-sm text-slate-500 truncate'>Estadio Magico Gonzales</p>
          <div className="flex flex-row items-center gap-1">
