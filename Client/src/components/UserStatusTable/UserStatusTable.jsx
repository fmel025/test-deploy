          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <input type="checkbox" />
                <div className="bg-green-400 flex justify-center rounded-xl font-bold px-10 py-1 swap-on">Activo</div>
                <div className="bg-red-400 flex justify-center rounded-xl font-bold px-10 py-1 swap-off">Inactivo</div>
                </label>
              </td>
            </tr>
            {/* row 2 */}
