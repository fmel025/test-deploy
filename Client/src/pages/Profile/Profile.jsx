    ...
    <>
      <Layout >
        <div className="card lg:card-side bg-base-100 shadow-xl m-10 ">
          <figure><img src="https://images.unsplash.com/photo-1529665253569-6d01c0eaf7b6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=785&q=80" alt="Album" className='h-96' /></figure>
          <div className="card-body">
            <h2 className="card-title font-bold text-indigo-500">Perfil de usuario</h2>
            <h3 className=" font-bold text-black mt-5">Usuario</h3>
            <p className=" font-regular text-blueGray-400">SamCar96</p>
